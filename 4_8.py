...
def display(): print("Теперь я тут PRINT()")
display()
################################################################################
...
while True:
    a = int(input('Какой длины должно быть число:'))
    if a<7:
...
# l = list(map(int, input('Из каких цифр только должно состоять число: ').split()))
while True:
    l = input('Из каких цифр только должно состоять число: ')
    try:
